...
export enum UserPermission {
  ...
  ATTENDANCE_INVITE = 'attendance:invite',
  ATTENDANCE_REVOKE = 'attendance:revoke',
  ATTENDANCE_GATE_SCAN = 'attendance:gate:scan',
...
export const SUPERADMIN_DEFAULT_PERMISSIONS: UserPermission[] = [
  ...
  UserPermission.ATTENDANCE_READ,
  UserPermission.ATTENDANCE_CREATE,
  UserPermission.ATTENDANCE_INVITE,
  UserPermission.ATTENDANCE_REVOKE,
  UserPermission.ATTENDANCE_GATE_SCAN,
